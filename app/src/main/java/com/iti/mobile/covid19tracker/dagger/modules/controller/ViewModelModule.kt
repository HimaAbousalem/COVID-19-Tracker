...
import com.iti.mobile.covid19tracker.features.statisticsView.StatisticsViewModel
...
abstract class ViewModelModule {
    ...
    internal abstract fun mapViewModel(viewModel: StatisticsViewModel): ViewModel
}